...
import { type FiltersState, initialState, setFilters } from "@/state"
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            <h4 className="font-bold mb-1">Beds</h4>
            <Select
          ...
          <div className="flex-1">
            <h4 className="font-bold mb-1 ml-1">Baths</h4>
            <Select
        ...
        {/* Available from */}
        <div>
          <h4 className="font-bold mb-2">Availble From</h4>
          <Input
            type="date"
            value={
