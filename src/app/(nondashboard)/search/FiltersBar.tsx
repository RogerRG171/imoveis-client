...
const FiltersBar = () => {
  ...
  const { isFiltersFullOpen, filters, viewMode } = useAppSelector(
    (state) => state.global,
  )
      ...
      <div className="flex justify-between items-center gap-3 lg:gap-5 overflow-x-auto scrollbar-hide">
        ...
        <div className="flex items-center">
          ...
          <Button
            ...
            className={`rounded-r-xl rounded-l-none border-l-none border-primary-400
          shadow-none border hover:bg-primary-700 hover:text-primary-50`}
          >
