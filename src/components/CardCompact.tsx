      ...
      <div className="w-2/3 p-4 flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-start">
            <h2 className="text-base lg:text-xl font-bold mb-1">
              {propertyLink ? (
                <Link
                  href={propertyLink}
          ...
          <p className="text-gray-600 mb-1 lg:mb-2 text-xs lg:text-base">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center text-sm">
